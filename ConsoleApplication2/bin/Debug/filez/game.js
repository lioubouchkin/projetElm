...
var _user$project$Game$decodePickCard = A5(
...
var _user$project$Game$stopGame = function () {
	var url = A2(_elm_lang$core$Basics_ops['++'], 'http://localhost:8080/stopGame/', _user$project$Game$model.pl.name);
	var request = A2(_elm_lang$http$Http$get, url, _user$project$Game$decodeStopGame);
	return A2(_elm_lang$http$Http$send, _user$project$Game$StopGameResponse, request);
}();
var _user$project$Game$StopGame = {ctor: 'StopGame'};
...
var _user$project$Game$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'StopGame':
				return {ctor: '_Tuple2', _0: model, _1: _user$project$Game$stopGame};
